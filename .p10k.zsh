# Generated by Powerlevel10k configuration wizard on 2021-01-20 at 20:58 PST.
...
# 24h time, angled separators, slanted heads, slanted tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL8K_DISK_USAGE_ONLY_WARNING=false
  # Custom icon.
